...
sudo scutil --set ComputerName "Coiled"
sudo scutil --set HostName "Coiled"
sudo scutil --set LocalHostName "Coiled"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Coiled"
...
sudo systemsetup -settimezone "US/Central" > /dev/null
